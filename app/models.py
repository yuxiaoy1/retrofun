...
from sqlalchemy import Column, ForeignKey, String, Text, distinct, func, or_
...
class Product(db.Model):
    ...
    countries: Mapped[list["Country"]] = relationship(
        back_populates="products", secondary=ProductCountry
    )
...
class Country(db.Model):
    ...
    products: Mapped[list["Product"]] = relationship(
        back_populates="countries", secondary=ProductCountry
    )
